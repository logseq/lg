...
if test "$dispatch_count" -ne 205; then
...
if test "$form_dispatch_count" -ne 142; then
  echo "compiler form dispatch changed: expected 142 names, found $form_dispatch_count" >&2
