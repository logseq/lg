...
awk -F '\t' '$1 == "compiler-call" && $2 == "__lg_print_output_line" && $3 == "typed-primitive" && $4 == "typed-static-string-output-with-boolean-newline-primitive" {found=1} END {exit !found}' "$tmp/inventory.tsv"
