...
awk -F '\t' '$1 == "definition" && $2 == "clojure.core/object-array" && $3 == "source" && $4 == "source-port-preserves-upstream-size-seqable-fill-and-seq-padding-arities-through-a-typed-object-array-source-protocol" {found=1} END {exit !found}' "$tmp/manifest-status.tsv"
