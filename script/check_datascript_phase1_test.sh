...
expect_no_hints_between \
  ...
  '\^(:[[:alpha:]]|[[:alpha:]])'
expect_no_hints_between \
  "pull parser attribute modifiers contain no local type hints" \
  test/datascript/upstream/pull_parser.cljc \
  parse-attr-name with-alias \
  '\^(:[[:alpha:]]|[[:alpha:]])'
expect_no_hints_between \
  "pull parser option helpers contain no local type hints" \
  test/datascript/upstream/pull_parser.cljc \
  with-alias parse-attr-expr \
  '\^(:[[:alpha:]]|[[:alpha:]])'
expect_no_hints_between \
  "pull parser attribute expression helpers contain no local type hints" \
  test/datascript/upstream/pull_parser.cljc \
