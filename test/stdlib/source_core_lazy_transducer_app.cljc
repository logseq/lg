...
(println (= 2.0 (math/round 1.5)))
(println (= -1.0 (math/round -1.5)))
(println (= 0.0 (math/round ##NaN)))
(println (= 3 (math/get-exponent 8.0)))
(println (= -1023 (math/get-exponent 0.0)))
(println (= 1024 (math/get-exponent ##Inf)))
(println (> (math/next-after 1.0 ##Inf) 1.0))
(println (< (math/next-after -1.0 -2.0) -1.0))
(println (> (math/next-up 1.0) 1.0))
(println (= ##Inf (math/next-up ##Inf)))
(println (< (math/next-down 1.0) 1.0))
(println (= ##-Inf (math/next-down ##-Inf)))
(println (= 2.220446049250313e-16 (math/ulp 1.0)))
(println (> (math/ulp 0.0) 0.0))
(println (= 12.0 (math/scalb 1.5 3)))
(println (= 0.0 (math/scalb 0.0 4096)))
(println (= ##Inf (math/scalb ##Inf -4096)))
