...
for name in identity complement even? odd? not-any? not-every? split-at split-with nthnext nthrest bounded-count butlast take-last drop-last reverse zipmap; do
  for file in \
