...
for definition in bubble-max-key union intersection difference select project index map-invert rename-keys rename join 'subset?' 'superset?'; do
...
for definition in project rename index join; do
