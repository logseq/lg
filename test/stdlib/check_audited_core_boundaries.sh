...
-invoke	typed-primitive	function-invocation-is-the-static-callable-abi-for-functions-overloads-keywords-symbols-collections-multifns-and-deftype-ifn-methods-with-arity-specific-elaboration-rather-than-a-source-protocol-method
