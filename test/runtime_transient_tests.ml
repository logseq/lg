...
let test_set_lifecycle () =
  ...
  ignore (Lg_runtime.Runtime_transient.set_add set 2);
  ignore (Lg_runtime.Runtime_transient.set_disjoin set 1);
...
let test_vector_lifecycle () =
  ...
  ignore (Lg_runtime.Runtime_transient.vector_add vector 4);
  ignore (Lg_runtime.Runtime_transient.vector_pop vector);
