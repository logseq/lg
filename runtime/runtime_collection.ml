...
let empty_nil _ = None
let empty_string_nil _ = None
let empty_int_nil _ = None
let empty_float_nil _ = None
let empty_char_nil _ = None
let empty_keyword_nil _ = None
let empty_symbol_nil _ = None
let empty_bool_nil _ = None
let empty_unit_nil _ = None
let empty_host_unit_nil _ = None
let empty_fn_nil _ = None
let peek_list values = List.nth_opt values 0
let peek_vector values = Rrbvec.peek_back values
